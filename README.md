...
[![Latest Release](https://img.shields.io/github/tag/eventespresso/ee4-events-calendar.svg?style=flat&label=Latest%20Release)](https://github.com/eventespresso/ee4-events-calendar/releases)
[![Travis](https://travis-ci.org/eventespresso/ee4-events-calendar.svg?branch=master)](https://travis-ci.org/eventespresso/ee4-events-calendar)
...
[![Minimum EE Core Version:](https://img.shields.io/badge/Minimum%20EE%20core%20ver-4.3.0.p-red.svg)](https://github.com/eventespresso/event-espresso-core/releases/tag/4.3.0.p)

The Events Calendar for [Event Espresso 4](https://github.com/eventespresso/event-espresso-core) allows you to display your events in a way that your customers are familiar with. Make it easy for your customers to find events and to add your events to their own calendars so they don’t forget!
...
| **Some Links**|     |
|---- | --- |
**Support License** | Support for this add-on is not provided through this repository.  For support you can purchase a [Premium Support License](https://eventespresso.com/product/ee4-events-calendar?ee_ver=ee4&utm_source=github&utm_medium=link&utm_campaign=ee_addon_description_readme&utm_content=premium+support+license). 
**Documentation** | [View Documentation →](https://eventespresso.com/wiki/events-calendar-add-on?utm_source=github&utm_medium=link&utm_campaign=ee_addon_description_readme&utm_content=view+addon+documentation)
